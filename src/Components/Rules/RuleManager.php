...
class RuleManager
{
    ...
    public const TYPE_ROWS = 'turbine-rows';

    public const TYPE_CHECKBOX = 'turbine-checkbox';

    public const TYPE_RADIO = 'turbine-radio';

    public const TYPE_COLUMN = 'turbine-column';
